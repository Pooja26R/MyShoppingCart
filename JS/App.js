	...
	if(!(cookieValue==="")&&!(cookieValue===null))
		{
			...
			newDiv.id=product_id
									   ...
									   let myDelButton=`<button class="badge badge-pill badge-danger"  style="padding:10px;" onclick="removeItem(${product_id})"> <i class="bi bi-trash3"></i></button>`
...
function proceedPayment(total){
	let cardDiv=`<img src="Images/Visa.jpg" style="height:20px; width:25px;"><img src="Images/mastercard.png"
	style="margin-left:10px;height:20px; width:25px;"><img src="Images/credit.jpg"style="margin-left:15px;height:20px;
	 width:25px;""><img src=" Images/debit.jpg"style="margin-left:20px;height:20px; width:25px;">`
